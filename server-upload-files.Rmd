...
hh_comp <- read.csv("hh_comp.xlsx")
write.csv(hh_comp, "/nfs/data/Applications/Ambulatory/hh_comp.csv")

# HH Unit Crosswalk 
hh_crosswalk <- read.csv("hh_crosswalk.xlsx")
write.csv(hh_crosswalk, "/nfs/data/Applications/Ambulatory/hh_crosswalk.csv")

# Radiology Volume Monthly Summary Data 
Radiology_Data <- read.csv("Radiology_Data.xlsx")
write.csv(Radiology_Data, "/nfs/data/Applications/Ambulatory/Radiology_Data.csv")

# Radiology Site Mapping 
Radiology_Site_Mapping <- read.csv("Radiology_Site_Mapping.xlsx")
write.csv(Radiology_Site_Mapping, "/nfs/data/Applications/Ambulatory/Radiology_Site_Mapping.csv")

# Rad Onc Volume Monthly Summary Data 
Rad_Onc_Data <- read.csv("Rad_Onc_Data.xlsx")
write.csv(Rad_Onc_Data, "/nfs/data/Applications/Ambulatory/Rad_Onc_Data.csv")

# Open Encounters Exclusion Criteria
open_enc_exc <- read_excel("open_encounters_exclusion.xlsx")
write_xlsx(open_enc_exc, "/nfs/data/Applications/Ambulatory/open_encounters_exclusion.xlsx")

# Epic Department Crosswalk
epic_depts <- read.csv("Epic Department Mapping Correction.csv")
write.csv(epic_depts, "/nfs/data/Applications/Ambulatory/Epic Department Mapping Correction.csv")

# Mount Sinai Logo
logo <- readPNG("Mount_Sinai_Logo_H.png")
png("Mount_Sinai_Logo_H.png")
